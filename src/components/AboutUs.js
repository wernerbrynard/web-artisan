    ...
    <Container maxW={'5xl'} py={12}>
        <Stack spacing={4} textAlign="center" alignItems="center">
          ...
          <Text color={'var(--text-light-color)'} fontSize={'lg'} maxW="4xl">
            Web Artisan is a digital product agency dedicated to crafting exceptional software. We combine creative design with robust engineering to deliver specialized solutions that drive business growth. From local motorsport brands to international enterprises, we help clients establish a commanding digital presence.
          </Text>
          <Text color={'var(--text-light-color)'} fontSize={'lg'} maxW="4xl">
            Founded on the principles of craftsmanship and technical excellence, Web Artisan partners with clients to navigate the complex digital landscape. Our team leverages cutting-edge technologies like React, Next.js, and Cloud Infrastructure to build scalable, high-performance applications.
          </Text>
